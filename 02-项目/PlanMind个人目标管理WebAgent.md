...
| **Vault 数据路径** | `C:\Users\22061\Documents\Obsidian Vault\08-PlanMind` |
...
- **☀️ 当日计划**：聚焦今日 7 项攻坚清单，直连 `08-PlanMind/04-日计划/YYYY-MM-DD.md`。
- **🗓️ 当周目标**：周度阶段里程碑与硬节点，直连 `08-PlanMind/03-周目标/YYYY-WXX.md`。
- **📆 当月目标**：月度冲刺关键结果，直连 `08-PlanMind/02-月度目标/YYYY-MM.md`。
- **📅 当年目标**：年度宏观战略主线，直连 `08-PlanMind/01-年度目标/YYYY.md`。
- **🎯 长期与总规划**：考研北邮（085401）与微电子/嵌入式职业发展，直连 `08-PlanMind/05-长期目标/`。
...
- 目标数据中心：[[08-PlanMind/00-INDEX|PlanMind 目标中心]]
- 长期方向规划：[[08-PlanMind/05-长期目标/职业发展|职业发展规划]]
